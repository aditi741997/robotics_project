...
public:
	...
	double last_allscan_mapCB_navPlan_navCmd_out, last_allscan_mapCB_navCmd_out;
	...
	std::vector<double> lat_allscan_mapCB_navCmd_arr, lat_allscan_mapCB_navPlan_navCmd_arr;	
	...
	std::vector<double> tput_allscan_mapCB_navPlan_navCmd_arr, tput_allscan_mapCB_navCmd_arr;
	...
	std::vector<double>  rt_allscan_mapCB_navCmd_arr, rt_allscan_mapCB_navPlan_navCmd_arr;
	...
	std::vector<double> ts_allscan_mapCB_navCmd_arr, ts_allscan_mapCB_navPlan_navCmd_arr;
	...
	long count_allscan_mapCB_navCmd, count_allscan_mapCB_navPlan_navCmd;
