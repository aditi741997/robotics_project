...
std::shared_ptr< monty::ndarray< int,1 > > shape{};virtual void destroy();
static BaseExpression::t _new_BaseExpression(std::shared_ptr< monty::ndarray< int,1 > > _6757);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _6757);
virtual /* override */ std::string toString() ;
virtual void printStack(monty::rc_ptr< ::mosek::fusion::WorkStack > _6758) ;
virtual void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6784,monty::rc_ptr< ::mosek::fusion::WorkStack > _6785,monty::rc_ptr< ::mosek::fusion::WorkStack > _6786) { throw monty::AbstractClassError("Call to abstract method"); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__pick(std::shared_ptr< monty::ndarray< int,2 > > _6787) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__pick(std::shared_ptr< monty::ndarray< int,2 > > _6787) { return __mosek_2fusion_2BaseExpression__pick(_6787); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__pick(std::shared_ptr< monty::ndarray< int,1 > > _6788) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__pick(std::shared_ptr< monty::ndarray< int,1 > > _6788) { return __mosek_2fusion_2BaseExpression__pick(_6788); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__index(std::shared_ptr< monty::ndarray< int,1 > > _6791) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__index(std::shared_ptr< monty::ndarray< int,1 > > _6791) { return __mosek_2fusion_2BaseExpression__index(_6791); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__index(int _6794) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__index(int _6794) { return __mosek_2fusion_2BaseExpression__index(_6794); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__slice(std::shared_ptr< monty::ndarray< int,1 > > _6796,std::shared_ptr< monty::ndarray< int,1 > > _6797) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__slice(std::shared_ptr< monty::ndarray< int,1 > > _6796,std::shared_ptr< monty::ndarray< int,1 > > _6797) { return __mosek_2fusion_2BaseExpression__slice(_6796,_6797); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__slice(int _6798,int _6799) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__slice(int _6798,int _6799) { return __mosek_2fusion_2BaseExpression__slice(_6798,_6799); }
virtual long long getSize() ;
virtual int getND() ;
virtual int getDim(int _6800) ;
virtual std::shared_ptr< monty::ndarray< int,1 > > getShape() ;
...
static ExprConst::t _new_ExprConst(std::shared_ptr< monty::ndarray< int,1 > > _4447,std::shared_ptr< monty::ndarray< long long,1 > > _4448,std::shared_ptr< monty::ndarray< double,1 > > _4449);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4447,std::shared_ptr< monty::ndarray< long long,1 > > _4448,std::shared_ptr< monty::ndarray< double,1 > > _4449);
static ExprConst::t _new_ExprConst(std::shared_ptr< monty::ndarray< int,1 > > _4450,std::shared_ptr< monty::ndarray< long long,1 > > _4451,double _4452);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4450,std::shared_ptr< monty::ndarray< long long,1 > > _4451,double _4452);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4455,monty::rc_ptr< ::mosek::fusion::WorkStack > _4456,monty::rc_ptr< ::mosek::fusion::WorkStack > _4457) ;
static  void validate(std::shared_ptr< monty::ndarray< int,1 > > _4476,std::shared_ptr< monty::ndarray< double,1 > > _4477,std::shared_ptr< monty::ndarray< long long,1 > > _4478);
virtual /* override */ std::string toString() ;
}; // struct ExprConst;
...
static ExprPick::t _new_ExprPick(monty::rc_ptr< ::mosek::fusion::Expression > _4482,std::shared_ptr< monty::ndarray< int,2 > > _4483);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4482,std::shared_ptr< monty::ndarray< int,2 > > _4483);
static ExprPick::t _new_ExprPick(monty::rc_ptr< ::mosek::fusion::Expression > _4495,std::shared_ptr< monty::ndarray< long long,1 > > _4496);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4495,std::shared_ptr< monty::ndarray< long long,1 > > _4496);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4501,monty::rc_ptr< ::mosek::fusion::WorkStack > _4502,monty::rc_ptr< ::mosek::fusion::WorkStack > _4503) ;
virtual /* override */ std::string toString() ;
}; // struct ExprPick;
...
static ExprSlice::t _new_ExprSlice(monty::rc_ptr< ::mosek::fusion::Expression > _4568,std::shared_ptr< monty::ndarray< int,1 > > _4569,std::shared_ptr< monty::ndarray< int,1 > > _4570);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4568,std::shared_ptr< monty::ndarray< int,1 > > _4569,std::shared_ptr< monty::ndarray< int,1 > > _4570);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4571,monty::rc_ptr< ::mosek::fusion::WorkStack > _4572,monty::rc_ptr< ::mosek::fusion::WorkStack > _4573) ;
static  std::shared_ptr< monty::ndarray< int,1 > > makeShape(std::shared_ptr< monty::ndarray< int,1 > > _4638,std::shared_ptr< monty::ndarray< int,1 > > _4639,std::shared_ptr< monty::ndarray< int,1 > > _4640);
virtual /* override */ std::string toString() ;
}; // struct ExprSlice;
...
static ExprPermuteDims::t _new_ExprPermuteDims(std::shared_ptr< monty::ndarray< int,1 > > _4645,monty::rc_ptr< ::mosek::fusion::Expression > _4646);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4645,monty::rc_ptr< ::mosek::fusion::Expression > _4646);
static ExprPermuteDims::t _new_ExprPermuteDims(std::shared_ptr< monty::ndarray< int,1 > > _4652,monty::rc_ptr< ::mosek::fusion::Expression > _4653,int _4654);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4652,monty::rc_ptr< ::mosek::fusion::Expression > _4653,int _4654);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4655,monty::rc_ptr< ::mosek::fusion::WorkStack > _4656,monty::rc_ptr< ::mosek::fusion::WorkStack > _4657) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeshape(std::shared_ptr< monty::ndarray< int,1 > > _4711,std::shared_ptr< monty::ndarray< int,1 > > _4712);
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprTranspose::t _new_ExprTranspose(monty::rc_ptr< ::mosek::fusion::Expression > _4714);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4714);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4715,monty::rc_ptr< ::mosek::fusion::WorkStack > _4716,monty::rc_ptr< ::mosek::fusion::WorkStack > _4717) ;
virtual /* override */ std::string toString() ;
static  std::shared_ptr< monty::ndarray< int,1 > > transposeShape(std::shared_ptr< monty::ndarray< int,1 > > _4770);
...
static ExprRepeat::t _new_ExprRepeat(monty::rc_ptr< ::mosek::fusion::Expression > _4771,int _4772,int _4773);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4771,int _4772,int _4773);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4774,monty::rc_ptr< ::mosek::fusion::WorkStack > _4775,monty::rc_ptr< ::mosek::fusion::WorkStack > _4776) ;
static  std::shared_ptr< monty::ndarray< int,1 > > getshape(monty::rc_ptr< ::mosek::fusion::Expression > _4841,int _4842,int _4843);
virtual /* override */ std::string toString() ;
}; // struct ExprRepeat;
...
static ExprStack::t _new_ExprStack(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _4848,int _4849);
void _initialize(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _4848,int _4849);
...
static  std::shared_ptr< monty::ndarray< int,1 > > getshape(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _4997,int _4998);
virtual /* override */ std::string toString() ;
}; // struct ExprStack;
...
static ExprInner::t _new_ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > _5012,std::shared_ptr< monty::ndarray< long long,1 > > _5013,std::shared_ptr< monty::ndarray< double,1 > > _5014);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _5012,std::shared_ptr< monty::ndarray< long long,1 > > _5013,std::shared_ptr< monty::ndarray< double,1 > > _5014);
static ExprInner::t _new_ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > _5020,std::shared_ptr< monty::ndarray< double,1 > > _5021);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _5020,std::shared_ptr< monty::ndarray< double,1 > > _5021);
static ExprInner::t _new_ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > _5023,std::shared_ptr< monty::ndarray< int,2 > > _5024,std::shared_ptr< monty::ndarray< double,1 > > _5025);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _5023,std::shared_ptr< monty::ndarray< int,2 > > _5024,std::shared_ptr< monty::ndarray< double,1 > > _5025);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5026,monty::rc_ptr< ::mosek::fusion::WorkStack > _5027,monty::rc_ptr< ::mosek::fusion::WorkStack > _5028) ;
static  std::shared_ptr< monty::ndarray< long long,1 > > range(int _5072);
static  std::shared_ptr< monty::ndarray< long long,1 > > convert(std::shared_ptr< monty::ndarray< int,1 > > _5074,std::shared_ptr< monty::ndarray< int,2 > > _5075);
virtual /* override */ std::string toString() ;
}; // struct ExprInner;
...
static ExprMulDiagRight::t _new_ExprMulDiagRight(int _5082,int _5083,std::shared_ptr< monty::ndarray< int,1 > > _5084,std::shared_ptr< monty::ndarray< int,1 > > _5085,std::shared_ptr< monty::ndarray< double,1 > > _5086,monty::rc_ptr< ::mosek::fusion::Expression > _5087,int _5088);
void _initialize(int _5082,int _5083,std::shared_ptr< monty::ndarray< int,1 > > _5084,std::shared_ptr< monty::ndarray< int,1 > > _5085,std::shared_ptr< monty::ndarray< double,1 > > _5086,monty::rc_ptr< ::mosek::fusion::Expression > _5087,int _5088);
static ExprMulDiagRight::t _new_ExprMulDiagRight(int _5089,int _5090,std::shared_ptr< monty::ndarray< int,1 > > _5091,std::shared_ptr< monty::ndarray< int,1 > > _5092,std::shared_ptr< monty::ndarray< double,1 > > _5093,monty::rc_ptr< ::mosek::fusion::Expression > _5094);
void _initialize(int _5089,int _5090,std::shared_ptr< monty::ndarray< int,1 > > _5091,std::shared_ptr< monty::ndarray< int,1 > > _5092,std::shared_ptr< monty::ndarray< double,1 > > _5093,monty::rc_ptr< ::mosek::fusion::Expression > _5094);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5095,monty::rc_ptr< ::mosek::fusion::WorkStack > _5096,monty::rc_ptr< ::mosek::fusion::WorkStack > _5097) ;
static  int validate(int _5176,int _5177,std::shared_ptr< monty::ndarray< int,1 > > _5178,std::shared_ptr< monty::ndarray< int,1 > > _5179,std::shared_ptr< monty::ndarray< double,1 > > _5180,monty::rc_ptr< ::mosek::fusion::Expression > _5181);
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprMulDiagLeft::t _new_ExprMulDiagLeft(int _5190,int _5191,std::shared_ptr< monty::ndarray< int,1 > > _5192,std::shared_ptr< monty::ndarray< int,1 > > _5193,std::shared_ptr< monty::ndarray< double,1 > > _5194,monty::rc_ptr< ::mosek::fusion::Expression > _5195,int _5196);
void _initialize(int _5190,int _5191,std::shared_ptr< monty::ndarray< int,1 > > _5192,std::shared_ptr< monty::ndarray< int,1 > > _5193,std::shared_ptr< monty::ndarray< double,1 > > _5194,monty::rc_ptr< ::mosek::fusion::Expression > _5195,int _5196);
static ExprMulDiagLeft::t _new_ExprMulDiagLeft(int _5197,int _5198,std::shared_ptr< monty::ndarray< int,1 > > _5199,std::shared_ptr< monty::ndarray< int,1 > > _5200,std::shared_ptr< monty::ndarray< double,1 > > _5201,monty::rc_ptr< ::mosek::fusion::Expression > _5202);
void _initialize(int _5197,int _5198,std::shared_ptr< monty::ndarray< int,1 > > _5199,std::shared_ptr< monty::ndarray< int,1 > > _5200,std::shared_ptr< monty::ndarray< double,1 > > _5201,monty::rc_ptr< ::mosek::fusion::Expression > _5202);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5203,monty::rc_ptr< ::mosek::fusion::WorkStack > _5204,monty::rc_ptr< ::mosek::fusion::WorkStack > _5205) ;
static  int validate(int _5303,int _5304,std::shared_ptr< monty::ndarray< int,1 > > _5305,std::shared_ptr< monty::ndarray< int,1 > > _5306,std::shared_ptr< monty::ndarray< double,1 > > _5307,monty::rc_ptr< ::mosek::fusion::Expression > _5308);
virtual /* override */ std::string toString() ;
...
static ExprMulElement::t _new_ExprMulElement(std::shared_ptr< monty::ndarray< double,1 > > _5317,std::shared_ptr< monty::ndarray< long long,1 > > _5318,monty::rc_ptr< ::mosek::fusion::Expression > _5319);
void _initialize(std::shared_ptr< monty::ndarray< double,1 > > _5317,std::shared_ptr< monty::ndarray< long long,1 > > _5318,monty::rc_ptr< ::mosek::fusion::Expression > _5319);
static ExprMulElement::t _new_ExprMulElement(std::shared_ptr< monty::ndarray< double,1 > > _5326,std::shared_ptr< monty::ndarray< long long,1 > > _5327,monty::rc_ptr< ::mosek::fusion::Expression > _5328,int _5329);
void _initialize(std::shared_ptr< monty::ndarray< double,1 > > _5326,std::shared_ptr< monty::ndarray< long long,1 > > _5327,monty::rc_ptr< ::mosek::fusion::Expression > _5328,int _5329);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5330,monty::rc_ptr< ::mosek::fusion::WorkStack > _5331,monty::rc_ptr< ::mosek::fusion::WorkStack > _5332) ;
virtual /* override */ std::string toString() ;
...
static ExprMulScalarConst::t _new_ExprMulScalarConst(double _5390,monty::rc_ptr< ::mosek::fusion::Expression > _5391);
void _initialize(double _5390,monty::rc_ptr< ::mosek::fusion::Expression > _5391);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5392,monty::rc_ptr< ::mosek::fusion::WorkStack > _5393,monty::rc_ptr< ::mosek::fusion::WorkStack > _5394) ;
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprScalarMul::t _new_ExprScalarMul(int _5432,int _5433,std::shared_ptr< monty::ndarray< int,1 > > _5434,std::shared_ptr< monty::ndarray< int,1 > > _5435,std::shared_ptr< monty::ndarray< double,1 > > _5436,monty::rc_ptr< ::mosek::fusion::Expression > _5437,int _5438);
void _initialize(int _5432,int _5433,std::shared_ptr< monty::ndarray< int,1 > > _5434,std::shared_ptr< monty::ndarray< int,1 > > _5435,std::shared_ptr< monty::ndarray< double,1 > > _5436,monty::rc_ptr< ::mosek::fusion::Expression > _5437,int _5438);
static ExprScalarMul::t _new_ExprScalarMul(int _5439,int _5440,std::shared_ptr< monty::ndarray< int,1 > > _5441,std::shared_ptr< monty::ndarray< int,1 > > _5442,std::shared_ptr< monty::ndarray< double,1 > > _5443,monty::rc_ptr< ::mosek::fusion::Expression > _5444);
void _initialize(int _5439,int _5440,std::shared_ptr< monty::ndarray< int,1 > > _5441,std::shared_ptr< monty::ndarray< int,1 > > _5442,std::shared_ptr< monty::ndarray< double,1 > > _5443,monty::rc_ptr< ::mosek::fusion::Expression > _5444);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5445,monty::rc_ptr< ::mosek::fusion::WorkStack > _5446,monty::rc_ptr< ::mosek::fusion::WorkStack > _5447) ;
static  int validate(int _5483,int _5484,std::shared_ptr< monty::ndarray< int,1 > > _5485,std::shared_ptr< monty::ndarray< int,1 > > _5486,std::shared_ptr< monty::ndarray< double,1 > > _5487,monty::rc_ptr< ::mosek::fusion::Expression > _5488);
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprMulRight::t _new_ExprMulRight(int _5495,int _5496,std::shared_ptr< monty::ndarray< int,1 > > _5497,std::shared_ptr< monty::ndarray< int,1 > > _5498,std::shared_ptr< monty::ndarray< double,1 > > _5499,monty::rc_ptr< ::mosek::fusion::Expression > _5500,int _5501);
void _initialize(int _5495,int _5496,std::shared_ptr< monty::ndarray< int,1 > > _5497,std::shared_ptr< monty::ndarray< int,1 > > _5498,std::shared_ptr< monty::ndarray< double,1 > > _5499,monty::rc_ptr< ::mosek::fusion::Expression > _5500,int _5501);
static ExprMulRight::t _new_ExprMulRight(int _5502,int _5503,std::shared_ptr< monty::ndarray< int,1 > > _5504,std::shared_ptr< monty::ndarray< int,1 > > _5505,std::shared_ptr< monty::ndarray< double,1 > > _5506,monty::rc_ptr< ::mosek::fusion::Expression > _5507);
void _initialize(int _5502,int _5503,std::shared_ptr< monty::ndarray< int,1 > > _5504,std::shared_ptr< monty::ndarray< int,1 > > _5505,std::shared_ptr< monty::ndarray< double,1 > > _5506,monty::rc_ptr< ::mosek::fusion::Expression > _5507);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5508,monty::rc_ptr< ::mosek::fusion::WorkStack > _5509,monty::rc_ptr< ::mosek::fusion::WorkStack > _5510) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeshape(int _5654,std::shared_ptr< monty::ndarray< int,1 > > _5655);
static  int validate(int _5656,int _5657,std::shared_ptr< monty::ndarray< int,1 > > _5658,std::shared_ptr< monty::ndarray< int,1 > > _5659,std::shared_ptr< monty::ndarray< double,1 > > _5660,monty::rc_ptr< ::mosek::fusion::Expression > _5661);
virtual /* override */ std::string toString() ;
}; // struct ExprMulRight;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprMulLeft::t _new_ExprMulLeft(int _5670,int _5671,std::shared_ptr< monty::ndarray< int,1 > > _5672,std::shared_ptr< monty::ndarray< int,1 > > _5673,std::shared_ptr< monty::ndarray< double,1 > > _5674,monty::rc_ptr< ::mosek::fusion::Expression > _5675,int _5676);
void _initialize(int _5670,int _5671,std::shared_ptr< monty::ndarray< int,1 > > _5672,std::shared_ptr< monty::ndarray< int,1 > > _5673,std::shared_ptr< monty::ndarray< double,1 > > _5674,monty::rc_ptr< ::mosek::fusion::Expression > _5675,int _5676);
static ExprMulLeft::t _new_ExprMulLeft(int _5677,int _5678,std::shared_ptr< monty::ndarray< int,1 > > _5679,std::shared_ptr< monty::ndarray< int,1 > > _5680,std::shared_ptr< monty::ndarray< double,1 > > _5681,monty::rc_ptr< ::mosek::fusion::Expression > _5682);
void _initialize(int _5677,int _5678,std::shared_ptr< monty::ndarray< int,1 > > _5679,std::shared_ptr< monty::ndarray< int,1 > > _5680,std::shared_ptr< monty::ndarray< double,1 > > _5681,monty::rc_ptr< ::mosek::fusion::Expression > _5682);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5683,monty::rc_ptr< ::mosek::fusion::WorkStack > _5684,monty::rc_ptr< ::mosek::fusion::WorkStack > _5685) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeshape(int _5787,int _5788,std::shared_ptr< monty::ndarray< int,1 > > _5789);
static  int validate(int _5790,int _5791,std::shared_ptr< monty::ndarray< int,1 > > _5792,std::shared_ptr< monty::ndarray< int,1 > > _5793,std::shared_ptr< monty::ndarray< double,1 > > _5794,monty::rc_ptr< ::mosek::fusion::Expression > _5795);
virtual /* override */ std::string toString() ;
}; // struct ExprMulLeft;
...
static ExprMulVar::t _new_ExprMulVar(bool _5803,int _5804,int _5805,std::shared_ptr< monty::ndarray< int,1 > > _5806,std::shared_ptr< monty::ndarray< int,1 > > _5807,std::shared_ptr< monty::ndarray< double,1 > > _5808,monty::rc_ptr< ::mosek::fusion::Variable > _5809);
void _initialize(bool _5803,int _5804,int _5805,std::shared_ptr< monty::ndarray< int,1 > > _5806,std::shared_ptr< monty::ndarray< int,1 > > _5807,std::shared_ptr< monty::ndarray< double,1 > > _5808,monty::rc_ptr< ::mosek::fusion::Variable > _5809);
static ExprMulVar::t _new_ExprMulVar(bool _5812,int _5813,int _5814,std::shared_ptr< monty::ndarray< int,1 > > _5815,std::shared_ptr< monty::ndarray< int,1 > > _5816,std::shared_ptr< monty::ndarray< double,1 > > _5817,monty::rc_ptr< ::mosek::fusion::Variable > _5818,int _5819);
void _initialize(bool _5812,int _5813,int _5814,std::shared_ptr< monty::ndarray< int,1 > > _5815,std::shared_ptr< monty::ndarray< int,1 > > _5816,std::shared_ptr< monty::ndarray< double,1 > > _5817,monty::rc_ptr< ::mosek::fusion::Variable > _5818,int _5819);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5820,monty::rc_ptr< ::mosek::fusion::WorkStack > _5821,monty::rc_ptr< ::mosek::fusion::WorkStack > _5822) ;
virtual void eval_right(monty::rc_ptr< ::mosek::fusion::WorkStack > _5823,monty::rc_ptr< ::mosek::fusion::WorkStack > _5824,monty::rc_ptr< ::mosek::fusion::WorkStack > _5825) ;
virtual void eval_left(monty::rc_ptr< ::mosek::fusion::WorkStack > _5930,monty::rc_ptr< ::mosek::fusion::WorkStack > _5931,monty::rc_ptr< ::mosek::fusion::WorkStack > _5932) ;
virtual void validate(int _6005,int _6006,std::shared_ptr< monty::ndarray< int,1 > > _6007,std::shared_ptr< monty::ndarray< int,1 > > _6008,std::shared_ptr< monty::ndarray< double,1 > > _6009) ;
static  std::shared_ptr< monty::ndarray< int,1 > > resshape(int _6013,int _6014,std::shared_ptr< monty::ndarray< int,1 > > _6015,bool _6016);
virtual /* override */ std::string toString() ;
}; // struct ExprMulVar;
...
static ExprMulScalarVar::t _new_ExprMulScalarVar(int _6017,int _6018,std::shared_ptr< monty::ndarray< int,1 > > _6019,std::shared_ptr< monty::ndarray< int,1 > > _6020,std::shared_ptr< monty::ndarray< double,1 > > _6021,monty::rc_ptr< ::mosek::fusion::Variable > _6022);
void _initialize(int _6017,int _6018,std::shared_ptr< monty::ndarray< int,1 > > _6019,std::shared_ptr< monty::ndarray< int,1 > > _6020,std::shared_ptr< monty::ndarray< double,1 > > _6021,monty::rc_ptr< ::mosek::fusion::Variable > _6022);
static ExprMulScalarVar::t _new_ExprMulScalarVar(int _6027,int _6028,std::shared_ptr< monty::ndarray< int,1 > > _6029,std::shared_ptr< monty::ndarray< int,1 > > _6030,std::shared_ptr< monty::ndarray< double,1 > > _6031,monty::rc_ptr< ::mosek::fusion::Variable > _6032,int _6033);
void _initialize(int _6027,int _6028,std::shared_ptr< monty::ndarray< int,1 > > _6029,std::shared_ptr< monty::ndarray< int,1 > > _6030,std::shared_ptr< monty::ndarray< double,1 > > _6031,monty::rc_ptr< ::mosek::fusion::Variable > _6032,int _6033);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6034,monty::rc_ptr< ::mosek::fusion::WorkStack > _6035,monty::rc_ptr< ::mosek::fusion::WorkStack > _6036) ;
virtual /* override */ std::string toString() ;
...
static ExprMulVarScalarConst::t _new_ExprMulVarScalarConst(monty::rc_ptr< ::mosek::fusion::Variable > _6053,double _6054);
void _initialize(monty::rc_ptr< ::mosek::fusion::Variable > _6053,double _6054);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6055,monty::rc_ptr< ::mosek::fusion::WorkStack > _6056,monty::rc_ptr< ::mosek::fusion::WorkStack > _6057) ;
virtual /* override */ std::string toString() ;
...
static ExprAdd::t _new_ExprAdd(monty::rc_ptr< ::mosek::fusion::Expression > _6074,monty::rc_ptr< ::mosek::fusion::Expression > _6075,double _6076,double _6077);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6074,monty::rc_ptr< ::mosek::fusion::Expression > _6075,double _6076,double _6077);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6079,monty::rc_ptr< ::mosek::fusion::WorkStack > _6080,monty::rc_ptr< ::mosek::fusion::WorkStack > _6081) ;
virtual /* override */ std::string toString() ;
}; // struct ExprAdd;
...
static ExprWSum::t _new_ExprWSum(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _6215,std::shared_ptr< monty::ndarray< double,1 > > _6216);
void _initialize(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _6215,std::shared_ptr< monty::ndarray< double,1 > > _6216);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6223,monty::rc_ptr< ::mosek::fusion::WorkStack > _6224,monty::rc_ptr< ::mosek::fusion::WorkStack > _6225) ;
virtual /* override */ std::string toString() ;
}; // struct ExprWSum;
...
static ExprSumReduce::t _new_ExprSumReduce(int _6319,monty::rc_ptr< ::mosek::fusion::Expression > _6320);
void _initialize(int _6319,monty::rc_ptr< ::mosek::fusion::Expression > _6320);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6322,monty::rc_ptr< ::mosek::fusion::WorkStack > _6323,monty::rc_ptr< ::mosek::fusion::WorkStack > _6324) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeShape(int _6440,std::shared_ptr< monty::ndarray< int,1 > > _6441);
virtual /* override */ std::string toString() ;
...
static ExprDenseTril::t _new_ExprDenseTril(int _6445,int _6446,monty::rc_ptr< ::mosek::fusion::Expression > _6447,int _6448);
void _initialize(int _6445,int _6446,monty::rc_ptr< ::mosek::fusion::Expression > _6447,int _6448);
static ExprDenseTril::t _new_ExprDenseTril(int _6449,int _6450,monty::rc_ptr< ::mosek::fusion::Expression > _6451);
void _initialize(int _6449,int _6450,monty::rc_ptr< ::mosek::fusion::Expression > _6451);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6453,monty::rc_ptr< ::mosek::fusion::WorkStack > _6454,monty::rc_ptr< ::mosek::fusion::WorkStack > _6455) ;
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprDense::t _new_ExprDense(monty::rc_ptr< ::mosek::fusion::Expression > _6539);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6539);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6540,monty::rc_ptr< ::mosek::fusion::WorkStack > _6541,monty::rc_ptr< ::mosek::fusion::WorkStack > _6542) ;
virtual /* override */ std::string toString() ;
}; // struct ExprDense;
...
int dim1{};int dim0{};monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprSymmetrize::t _new_ExprSymmetrize(int _6583,int _6584,monty::rc_ptr< ::mosek::fusion::Expression > _6585,int _6586);
void _initialize(int _6583,int _6584,monty::rc_ptr< ::mosek::fusion::Expression > _6585,int _6586);
static ExprSymmetrize::t _new_ExprSymmetrize(int _6587,int _6588,monty::rc_ptr< ::mosek::fusion::Expression > _6589);
void _initialize(int _6587,int _6588,monty::rc_ptr< ::mosek::fusion::Expression > _6589);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6591,monty::rc_ptr< ::mosek::fusion::WorkStack > _6592,monty::rc_ptr< ::mosek::fusion::WorkStack > _6593) ;
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprCondense::t _new_ExprCondense(monty::rc_ptr< ::mosek::fusion::Expression > _6717);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6717);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6718,monty::rc_ptr< ::mosek::fusion::WorkStack > _6719,monty::rc_ptr< ::mosek::fusion::WorkStack > _6720) ;
virtual /* override */ std::string toString() ;
}; // struct ExprCondense;
...
static ExprFromVar::t _new_ExprFromVar(monty::rc_ptr< ::mosek::fusion::Variable > _6724);
void _initialize(monty::rc_ptr< ::mosek::fusion::Variable > _6724);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6725,monty::rc_ptr< ::mosek::fusion::WorkStack > _6726,monty::rc_ptr< ::mosek::fusion::WorkStack > _6727) ;
virtual /* override */ std::string toString() ;
}; // struct ExprFromVar;
...
static ExprReshape::t _new_ExprReshape(std::shared_ptr< monty::ndarray< int,1 > > _6744,monty::rc_ptr< ::mosek::fusion::Expression > _6745);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _6744,monty::rc_ptr< ::mosek::fusion::Expression > _6745);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6747,monty::rc_ptr< ::mosek::fusion::WorkStack > _6748,monty::rc_ptr< ::mosek::fusion::WorkStack > _6749) ;
virtual /* override */ std::string toString() ;
}; // struct ExprReshape;
...
static Expr::t _new_Expr(std::shared_ptr< monty::ndarray< long long,1 > > _6891,std::shared_ptr< monty::ndarray< long long,1 > > _6892,std::shared_ptr< monty::ndarray< double,1 > > _6893,std::shared_ptr< monty::ndarray< double,1 > > _6894,std::shared_ptr< monty::ndarray< int,1 > > _6895,std::shared_ptr< monty::ndarray< long long,1 > > _6896);
void _initialize(std::shared_ptr< monty::ndarray< long long,1 > > _6891,std::shared_ptr< monty::ndarray< long long,1 > > _6892,std::shared_ptr< monty::ndarray< double,1 > > _6893,std::shared_ptr< monty::ndarray< double,1 > > _6894,std::shared_ptr< monty::ndarray< int,1 > > _6895,std::shared_ptr< monty::ndarray< long long,1 > > _6896);
...
void _initialize(std::shared_ptr< monty::ndarray< long long,1 > > _6907,std::shared_ptr< monty::ndarray< long long,1 > > _6908,std::shared_ptr< monty::ndarray< double,1 > > _6909,std::shared_ptr< monty::ndarray< double,1 > > _6910,std::shared_ptr< monty::ndarray< int,1 > > _6911,std::shared_ptr< monty::ndarray< long long,1 > > _6912,int _6913);
static Expr::t _new_Expr(monty::rc_ptr< ::mosek::fusion::Expression > _6914);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6914);
virtual long long prod(std::shared_ptr< monty::ndarray< int,1 > > _6939) ;
static  std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > varstack(std::shared_ptr< monty::ndarray< std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > >,1 > > _6942);
static  std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > varstack(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6945,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6946);
static  monty::rc_ptr< ::mosek::fusion::Expression > condense(monty::rc_ptr< ::mosek::fusion::Expression > _6950);
static  monty::rc_ptr< ::mosek::fusion::Expression > flatten(monty::rc_ptr< ::mosek::fusion::Expression > _6951);
static  monty::rc_ptr< ::mosek::fusion::Expression > reshape(monty::rc_ptr< ::mosek::fusion::Expression > _6953,int _6954,int _6955);
static  monty::rc_ptr< ::mosek::fusion::Expression > reshape(monty::rc_ptr< ::mosek::fusion::Expression > _6956,int _6957);
static  monty::rc_ptr< ::mosek::fusion::Expression > reshape(monty::rc_ptr< ::mosek::fusion::Expression > _6958,std::shared_ptr< monty::ndarray< int,1 > > _6959);
virtual long long size() ;
static  monty::rc_ptr< ::mosek::fusion::Expression > zeros(std::shared_ptr< monty::ndarray< int,1 > > _6960);
static  monty::rc_ptr< ::mosek::fusion::Expression > zeros(int _6961);
static  monty::rc_ptr< ::mosek::fusion::Expression > ones();
static  monty::rc_ptr< ::mosek::fusion::Expression > ones(std::shared_ptr< monty::ndarray< int,1 > > _6962,std::shared_ptr< monty::ndarray< int,2 > > _6963);
static  monty::rc_ptr< ::mosek::fusion::Expression > ones(std::shared_ptr< monty::ndarray< int,1 > > _6964);
static  monty::rc_ptr< ::mosek::fusion::Expression > ones(int _6965);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _6966);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(monty::rc_ptr< ::mosek::fusion::Matrix > _6967);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(double _6976);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< int,1 > > _6977,std::shared_ptr< monty::ndarray< int,2 > > _6978,double _6979);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< int,1 > > _6987,std::shared_ptr< monty::ndarray< int,2 > > _6988,std::shared_ptr< monty::ndarray< double,1 > > _6989);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< int,1 > > _6997,double _6998);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(int _6999,double _7000);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< double,2 > > _7002);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< double,1 > > _7005);
virtual long long numNonzeros() ;
static  monty::rc_ptr< ::mosek::fusion::Expression > sum(monty::rc_ptr< ::mosek::fusion::Expression > _7006,int _7007);
static  monty::rc_ptr< ::mosek::fusion::Expression > sum(monty::rc_ptr< ::mosek::fusion::Expression > _7008);
static  monty::rc_ptr< ::mosek::fusion::Expression > neg(monty::rc_ptr< ::mosek::fusion::Expression > _7009);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(bool _7010,monty::rc_ptr< ::mosek::fusion::Matrix > _7011,monty::rc_ptr< ::mosek::fusion::Expression > _7012);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Variable > _7019,monty::rc_ptr< ::mosek::fusion::Parameter > _7020);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Parameter > _7021,monty::rc_ptr< ::mosek::fusion::Variable > _7022);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Expression > _7023,monty::rc_ptr< ::mosek::fusion::Parameter > _7024);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Parameter > _7025,monty::rc_ptr< ::mosek::fusion::Expression > _7026);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Variable > _7027,monty::rc_ptr< ::mosek::fusion::Matrix > _7028);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Matrix > _7029,monty::rc_ptr< ::mosek::fusion::Variable > _7030);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Expression > _7031,monty::rc_ptr< ::mosek::fusion::Matrix > _7032);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Matrix > _7033,monty::rc_ptr< ::mosek::fusion::Expression > _7034);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Variable > _7035,std::shared_ptr< monty::ndarray< double,2 > > _7036);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Expression > _7043,std::shared_ptr< monty::ndarray< double,2 > > _7044);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(std::shared_ptr< monty::ndarray< double,2 > > _7051,monty::rc_ptr< ::mosek::fusion::Variable > _7052);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(std::shared_ptr< monty::ndarray< double,2 > > _7059,monty::rc_ptr< ::mosek::fusion::Expression > _7060);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm_(monty::rc_ptr< ::mosek::fusion::Matrix > _7067,monty::rc_ptr< ::mosek::fusion::Expression > _7068);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm_(std::shared_ptr< monty::ndarray< double,1 > > _7077,monty::rc_ptr< ::mosek::fusion::Expression > _7078);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm_(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7080,monty::rc_ptr< ::mosek::fusion::Expression > _7081);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7084,double _7085);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(double _7086,monty::rc_ptr< ::mosek::fusion::Expression > _7087);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7088,std::shared_ptr< monty::ndarray< double,1 > > _7089);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(std::shared_ptr< monty::ndarray< double,1 > > _7090,monty::rc_ptr< ::mosek::fusion::Expression > _7091);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7092,std::shared_ptr< monty::ndarray< double,2 > > _7093);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(std::shared_ptr< monty::ndarray< double,2 > > _7094,monty::rc_ptr< ::mosek::fusion::Expression > _7095);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7096,monty::rc_ptr< ::mosek::fusion::Matrix > _7097);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Matrix > _7098,monty::rc_ptr< ::mosek::fusion::Expression > _7099);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7100,std::shared_ptr< monty::ndarray< double,1 > > _7101,monty::rc_ptr< ::mosek::fusion::Expression > _7102);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7117,std::shared_ptr< monty::ndarray< double,2 > > _7118,monty::rc_ptr< ::mosek::fusion::Expression > _7119);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7134,monty::rc_ptr< ::mosek::fusion::Matrix > _7135,monty::rc_ptr< ::mosek::fusion::Expression > _7136);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Variable > _7145,monty::rc_ptr< ::mosek::fusion::Matrix > _7146);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Matrix > _7152,monty::rc_ptr< ::mosek::fusion::Variable > _7153);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7159,int _7160,int _7161,std::shared_ptr< monty::ndarray< int,1 > > _7162,std::shared_ptr< monty::ndarray< int,1 > > _7163,std::shared_ptr< monty::ndarray< double,1 > > _7164,monty::rc_ptr< ::mosek::fusion::Variable > _7165);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7167,monty::rc_ptr< ::mosek::fusion::Parameter > _7168);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Parameter > _7169,monty::rc_ptr< ::mosek::fusion::Expression > _7170);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7171,monty::rc_ptr< ::mosek::fusion::Matrix > _7172);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7180,std::shared_ptr< monty::ndarray< double,2 > > _7181);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7185,monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7186);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7187,std::shared_ptr< monty::ndarray< double,1 > > _7188);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Matrix > _7193,monty::rc_ptr< ::mosek::fusion::Expression > _7194);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7195,monty::rc_ptr< ::mosek::fusion::Expression > _7196);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(std::shared_ptr< monty::ndarray< double,2 > > _7197,monty::rc_ptr< ::mosek::fusion::Expression > _7198);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(std::shared_ptr< monty::ndarray< double,1 > > _7199,monty::rc_ptr< ::mosek::fusion::Expression > _7200);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7201,monty::rc_ptr< ::mosek::fusion::Parameter > _7202);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Parameter > _7203,monty::rc_ptr< ::mosek::fusion::Expression > _7204);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(monty::rc_ptr< ::mosek::fusion::Matrix > _7205,monty::rc_ptr< ::mosek::fusion::Variable > _7206);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(monty::rc_ptr< ::mosek::fusion::Variable > _7213,monty::rc_ptr< ::mosek::fusion::Matrix > _7214);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(std::shared_ptr< monty::ndarray< double,1 > > _7221,monty::rc_ptr< ::mosek::fusion::Variable > _7222);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(monty::rc_ptr< ::mosek::fusion::Variable > _7224,std::shared_ptr< monty::ndarray< double,1 > > _7225);
...
virtual int peek_dim(int _6812) ;
virtual int peek_nd() ;
virtual void alloc_expr(int _6813,int _6814,int _6815,bool _6816) ;
virtual void alloc_expr(int _6817,int _6818,int _6819,bool _6820,int _6821) ;
virtual void pop_expr() ;
virtual void move_expr(monty::rc_ptr< ::mosek::fusion::WorkStack > _6822) ;
virtual void peek_expr() ;
virtual void ensure_sparsity() ;
virtual void clear() ;
virtual int allocf64(int _6837) ;
virtual int alloci64(int _6839) ;
virtual int alloci32(int _6841) ;
virtual void pushf64(double _6843) ;
virtual void pushi64(long long _6844) ;
virtual void pushi32(int _6845) ;
virtual void ensuref64(int _6846) ;
virtual void ensurei64(int _6849) ;
virtual void ensurei32(int _6852) ;
virtual int popf64(int _6855) ;
virtual int popi64(int _6856) ;
virtual int popi32(int _6857) ;
virtual void popf64(int _6858,std::shared_ptr< monty::ndarray< double,1 > > _6859,int _6860) ;
virtual void popi64(int _6861,std::shared_ptr< monty::ndarray< long long,1 > > _6862,int _6863) ;
virtual void popi32(int _6864,std::shared_ptr< monty::ndarray< int,1 > > _6865,int _6866) ;
...
virtual int peeki32() ;
virtual double peekf64(int _6867) ;
virtual long long peeki64(int _6868) ;
virtual int peeki32(int _6869) ;
}; // struct WorkStack;
...
static SymmetricExpr::t _new_SymmetricExpr(int _6870,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::SymmetricMatrix >,1 > > _6871,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6872,monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _6873);
void _initialize(int _6870,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::SymmetricMatrix >,1 > > _6871,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6872,monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _6873);
static  monty::rc_ptr< ::mosek::fusion::SymmetricExpr > add(monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6874,monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _6875);
static  monty::rc_ptr< ::mosek::fusion::SymmetricExpr > mul(monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6876,double _6877);
static  monty::rc_ptr< ::mosek::fusion::SymmetricExpr > add(monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6879,monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6880);
virtual /* override */ std::string toString() ;
...
static  int string_to_sparam_value(const std::string &  _8431);
static  int string_to_miomode_value(const std::string &  _8432);
static  int string_to_internal_liinf_value(const std::string &  _8433);
static  int string_to_dparam_value(const std::string &  _8434);
static  int string_to_prosta_value(const std::string &  _8435);
static  int string_to_miocontsoltype_value(const std::string &  _8436);
static  int string_to_callbackcode_value(const std::string &  _8437);
static  int string_to_uplo_value(const std::string &  _8438);
static  int string_to_simreform_value(const std::string &  _8439);
static  int string_to_xmlwriteroutputtype_value(const std::string &  _8440);
static  int string_to_feature_value(const std::string &  _8441);
static  int string_to_simdupvec_value(const std::string &  _8442);
static  int string_to_objsense_value(const std::string &  _8443);
static  int string_to_nametype_value(const std::string &  _8444);
static  int string_to_transpose_value(const std::string &  _8445);
static  int string_to_boundkey_value(const std::string &  _8446);
static  int string_to_basindtype_value(const std::string &  _8447);
static  int string_to_iomode_value(const std::string &  _8448);
static  int string_to_rescode_value(const std::string &  _8449);
static  int string_to_simseltype_value(const std::string &  _8450);
static  int string_to_orderingtype_value(const std::string &  _8451);
static  int string_to_soltype_value(const std::string &  _8452);
static  int string_to_rescodetype_value(const std::string &  _8453);
static  int string_to_onoffkey_value(const std::string &  _8454);
static  int string_to_simhotstart_value(const std::string &  _8455);
static  int string_to_solsta_value(const std::string &  _8456);
static  int string_to_solitem_value(const std::string &  _8457);
static  int string_to_purify_value(const std::string &  _8458);
static  int string_to_compresstype_value(const std::string &  _8459);
static  int string_to_streamtype_value(const std::string &  _8460);
static  int string_to_startpointtype_value(const std::string &  _8461);
static  int string_to_scalingtype_value(const std::string &  _8462);
static  int string_to_language_value(const std::string &  _8463);
static  int string_to_checkconvexitytype_value(const std::string &  _8464);
static  int string_to_iinfitem_value(const std::string &  _8465);
static  int string_to_presolvemode_value(const std::string &  _8466);
static  int string_to_variabletype_value(const std::string &  _8467);
static  int string_to_simdegen_value(const std::string &  _8468);
static  int string_to_problemitem_value(const std::string &  _8469);
static  int string_to_iparam_value(const std::string &  _8470);
static  int string_to_problemtype_value(const std::string &  _8471);
static  int string_to_dinfitem_value(const std::string &  _8472);
static  int string_to_mionodeseltype_value(const std::string &  _8473);
static  int string_to_internal_iinf_value(const std::string &  _8474);
static  int string_to_value_value(const std::string &  _8475);
static  int string_to_mark_value(const std::string &  _8476);
static  int string_to_symmattype_value(const std::string &  _8477);
static  int string_to_liinfitem_value(const std::string &  _8478);
static  int string_to_scopr_value(const std::string &  _8479);
static  int string_to_dataformat_value(const std::string &  _8480);
static  int string_to_parametertype_value(const std::string &  _8481);
static  int string_to_optimizertype_value(const std::string &  _8482);
static  int string_to_inftype_value(const std::string &  _8483);
static  int string_to_conetype_value(const std::string &  _8484);
static  int string_to_mpsformat_value(const std::string &  _8485);
static  int string_to_internal_dinf_value(const std::string &  _8486);
static  int string_to_solveform_value(const std::string &  _8487);
static  int string_to_intpnthotstart_value(const std::string &  _8488);
static  int string_to_scalingmethod_value(const std::string &  _8489);
static  int string_to_stakey_value(const std::string &  _8490);
static  int string_to_branchdir_value(const std::string &  _8491);
static  int string_to_sensitivitytype_value(const std::string &  _8492);
}; // struct Parameters;
