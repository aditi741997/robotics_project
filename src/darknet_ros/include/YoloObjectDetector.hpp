...
class YoloObjectDetector {
 ...
 private:
  ...
  // For recording compute time of yolo:
  std::vector<double> cis, ts;
  
  // for publishing ci data:
  ros::Publisher yolo_exec_end_pub, yolo_thr_info_pub;

  // save timings to get lat,tput,rt for ppcam-yolo chains.
  float last_cam_ts, last_cam_recv, last_cam_yolo_out;
  std::vector<double> lat_cam_yolo_arr, tput_cam_yolo_arr, rt_cam_yolo_arr, ts_cam_yolo_arr;
  long int cam_yolo_count;
