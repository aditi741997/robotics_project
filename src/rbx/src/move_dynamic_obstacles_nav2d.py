...
# for large map:
turn_poses_x = {'target1': [-19, 8.5, 2.75, 12.8, 19.8, -21.5, -12.5, -11.2], 'target0': [-24.3, 8.5, 2.75, 9.7, 15.5, -25.5, -16, -16]}
turn_poses_y = {'target1': [-8.25, -7.7, 11.6, 10, -8.2, 12.5, 0.0, 7.5], 'target0': [-8.25, -10.8, 7.5, 10, -8.2, 12.5, 0.0, 7.5]}
#'''
